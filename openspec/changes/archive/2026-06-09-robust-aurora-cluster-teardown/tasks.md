...
- [x] 6.3 Archive this change per the experimental workflow (`/opsx:archive`). — **DONE 2026-06-09**: spec synced to `openspec/specs/aurora-cluster-teardown/spec.md`; change moved to `openspec/changes/archive/2026-06-09-robust-aurora-cluster-teardown/`.
