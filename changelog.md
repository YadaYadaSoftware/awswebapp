...
**Purpose:** automate the testing of google login

**Date Created:** 2025-10-05 07:03:17
...
**Purpose:** the goal of this branch is to shorten the stack name changing the prefix to the domain name and getting rid of the region

**Date Created:** 2025-10-06 07:47:48
...
## [2025-10-06 08:18:23 UTC] local-connection-string (fix)

# Changes for fix/local-connection-string

**Purpose:** the local connection string is still a sql server connection string.  change it to mysql

**Date Created:** 2025-10-06 07:28:17
...
## [2025-10-05 07:01:45 UTC] test-changelog-refactor (system)
